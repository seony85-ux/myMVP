...
#### 4.7.1 화면 목적
- 루틴 완료에 대한 감사 메시지 표시
- 사용자에게 성취감 제공 및 다음 행동 유도

#### 4.7.2 기능 요구사항
- 감사 메시지 표시
- "처음으로" 버튼 클릭 시 인트로 화면으로 이동
- "다시 하기" 버튼 클릭 시 루틴 설정 화면으로 이동 (선택사항)

#### 4.7.3 UI/UX 요구사항
- **상단 영역**
  - 감사 메시지 제목 (예: "감사합니다" 또는 "오늘도 수고하셨어요")
  - 제목은 중앙 정렬, 큰 폰트
- **중앙 영역**
  - 짧은 감사 문구 표시
  - 문구는 중앙 정렬, 가독성 높은 폰트 크기
- **하단 영역**
  - [처음으로] 버튼 (필수)
  - [다시 하기] 버튼 (선택사항)
  - 버튼은 화면 하단 고정 또는 중앙 하단 배치
...
6. 결과 요약 화면 → 만족도/재사용 의향 선택 → [완료] 클릭
7. 감사 화면 → [처음으로] 또는 [다시 하기] 클릭 → 인트로 화면 또는 루틴 설정 화면으로 이동
